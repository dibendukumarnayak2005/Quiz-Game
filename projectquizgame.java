...
class QuizGame {
        ...
        for (int i = 0; i < gamePack.size(); i++) {
            ...
            try {
                ...
                if (mixedOptions.get(choice - 1).equals(currentQ.getCorrectAnswer())) {
                    ...
                    System.out.println(RED + "Oops! Not quite. The right answer was: " + currentQ.getCorrectAnswer()
                            + " 😅" + RESET);
                }
            } catch (Exception e) {
    ...
    private static void loadQuestions() {
        ...
        questions.add(new Question("Who developed Java?", "James Gosling", "Dennis Ritchie", "Bjarne Stroustrup",
                "Guido van Rossum"));
        ...
        questions.add(new Question("What does HTML stand for?", "Hyper Text Markup Language",
                "High Tech Modern Language", "Hyperlink and Text Markup Language", "Home Tool Markup Language"));
        questions.add(new Question("Which data structure follows LIFO?", "Stack", "Queue", "Array", "Linked List"));
        questions.add(new Question("Who wrote 'Harry Potter'?", "J.K. Rowling", "J.R.R. Tolkien", "Stephen King",
                "George R.R. Martin"));
        questions.add(new Question("What does 'RAM' stand for?", "Random Access Memory", "Read And Modify",
                "Rapid Action Module", "Run Access Mode"));
        questions.add(new Question("Which country invented pizza?", "Italy", "France", "USA", "Germany"));
        questions.add(new Question("Who was the first President of the USA?", "George Washington", "Abraham Lincoln",
                "Thomas Jefferson", "John Adams"));
        questions.add(new Question("What does CPU stand for?", "Central Processing Unit", "Computer Power Unit",
                "Central Programming Unit", "Core Processing Unit"));
        questions.add(new Question("Which ocean is the largest?", "Pacific Ocean", "Atlantic Ocean", "Indian Ocean",
                "Arctic Ocean"));
        questions.add(
                new Question("What is the national animal of India?", "Bengal Tiger", "Lion", "Elephant", "Leopard"));
        ...
        questions.add(new Question("Who painted the Mona Lisa?", "Leonardo da Vinci", "Pablo Picasso",
                "Vincent van Gogh", "Claude Monet"));
        questions.add(
                new Question("Which is the largest bone in the human body?", "Femur", "Humerus", "Tibia", "Skull"));
        questions.add(new Question("Who discovered gravity?", "Isaac Newton", "Albert Einstein", "Galileo Galilei",
                "Nikola Tesla"));
        questions.add(
                new Question("Which is the longest river in the world?", "Nile", "Amazon", "Yangtze", "Mississippi"));
        questions.add(new Question("What does the 'C' in C++ stand for?", "C language", "Code", "Computer", "Command"));
        questions.add(new Question("Which Indian city is known as the 'Pink City'?", "Jaipur", "Jodhpur", "Udaipur",
                "Bikaner"));
        questions.add(new Question("Which company created Python?", "Guido van Rossum", "Microsoft", "Sun Microsystems",
                "Google"));
        questions.add(new Question("Which cricketer has the highest number of international centuries?",
        ...
        questions.add(new Question("Which programming language is used for Android app development?", "Java", "Swift",
                "C#", "Kotlin"));
        questions.add(
                new Question("Who is the CEO of Tesla?", "Elon Musk", "Jeff Bezos", "Bill Gates", "Sundar Pichai"));
        questions.add(
                new Question("Which continent has the most countries?", "Africa", "Asia", "Europe", "South America"));
        ...
        questions.add(new Question("What does CSS stand for?", "Cascading Style Sheets", "Creative Style Sheets",
                "Computer Styling System", "Custom Style Syntax"));
        questions.add(new Question("Who invented the telephone?", "Alexander Graham Bell", "Thomas Edison",
                "Nikola Tesla", "James Watt"));
        questions.add(new Question("Which Indian state is known as the 'Spice Garden'?", "Kerala", "Tamil Nadu",
                "Andhra Pradesh", "West Bengal"));
        questions.add(new Question("How many bits are in a byte?", "8", "16", "32", "64"));
        questions.add(
                new Question("Which is the smallest planet in the solar system?", "Mercury", "Pluto", "Mars", "Venus"));
        questions.add(new Question("Which Olympic sport involves vault, beam, and floor exercises?", "Gymnastics",
                "Diving", "Athletics", "Fencing"));
        questions.add(new Question("Which programming language is known as the 'mother of all languages'?", "C",
                "Assembly", "Pascal", "Fortran"));
        questions.add(new Question("Which Hollywood movie features a robot named 'Wall-E'?", "Wall-E", "Transformers",
                "I, Robot", "Big Hero 6"));
        questions.add(new Question("Which gas is most abundant in Earth's atmosphere?", "Nitrogen", "Oxygen",
                "Carbon Dioxide", "Argon"));
        questions.add(new Question("Which is the world's fastest land animal?", "Cheetah", "Leopard", "Tiger", "Lion"));
        questions.add(new Question("Who wrote the famous book '1984'?", "George Orwell", "J.K. Rowling", "Mark Twain",
                "Charles Dickens"));
        questions.add(new Question("Which is the only even prime number?", "2", "4", "6", "8"));
        questions.add(new Question("Who is the founder of Facebook?", "Mark Zuckerberg", "Elon Musk", "Steve Jobs",
                "Larry Page"));
        questions.add(new Question("What does HTTP stand for?", "Hypertext Transfer Protocol",
                "High Tech Text Processing", "Hyperlink Transmission Protocol", "Hyper Tech Transfer Protocol"));
        questions.add(new Question("Which car company produces the Mustang?", "Ford", "Chevrolet", "BMW", "Ferrari"));
        questions.add(new Question("Who was the first man to walk on the moon?", "Neil Armstrong", "Buzz Aldrin",
                "Yuri Gagarin", "Michael Collins"));
        questions.add(new Question("Which Indian festival is known as the 'Festival of Lights'?", "Diwali", "Holi",
                "Navratri", "Eid"));
        questions.add(new Question("Which superhero is known as the 'Dark Knight'?", "Batman", "Superman", "Iron Man",
                "Spider-Man"));
